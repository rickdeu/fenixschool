...
urlpatterns = [
    ...
    path("boletins/", views.boletim_selection_view, name="boletim_selection"),
    path("boletins/ver/", views.boletim_view, name="boletim"),
    path("boletins/ver/pdf/", views.boletim_pdf_view, name="boletim_pdf"),
]
